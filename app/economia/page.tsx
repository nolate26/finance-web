        ...
        <>
          ...
          <div className="flex justify-end mb-3">
            <ExportButtons
              ...
              filename="market_valuations"
              pdf={{ title: "Market Valuations", subtitle: "Source: Bloomberg" }}
            />
          </div>
          ...
          <div className="flex justify-end mb-3">
            <ExportButtons
              sheets={() => {
                ...
                return [{ name: "Historical Prices", headers: ["Date", ...cols], rows }];
              }}
              filename="commodities_historical"
              pdf={{ title: "Commodities — Historical Prices", subtitle: "Source: Bloomberg" }}
            />
          </div>
          <CommoditiesPanel
          // eslint-disable-next-line @typescript-eslint/no-explicit-any
